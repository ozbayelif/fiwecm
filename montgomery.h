...
void montg_curve_pro_point_init_rand(MONTG_CURVE c, PRO_POINT p, ui n);

// Random montgomery curve and affine point initialization
void montg_curve_pro_point_init_rand(MONTG_CURVE c, AFF_POINT p, ui n);
...
void aff_ladder(ui x, ui z, ui x1, ui z1, ui k, ui n);
